...
class UNetSD_T2VBase(nn.Module):
    def __init__(self,
        ...
        init_block = nn.ModuleList([nn.Conv2d(self.in_dim*2, dim, 3, padding=1)])
        #print(init_block[0].bias.shape)
    ...
    def forward(self, 
        ...
        **kwargs):
        ...
        #print(x.shape, condition_latent.shape)
        ...
        x = torch.cat([x, condition_latent], dim= 1) 
