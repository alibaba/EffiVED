...
class ImageToSeqAugmenter(object):
    ...
    def __call__(self, image,image1, masks=None, boxes=None):
        ...
        if masks is not None:
            ...
            aug_image1, invalid_pts_mask = det_augmenter(image=image1, segmentation_maps=masks)
            #aug_image = det_augmenter(image=image)
            return aug_image, aug_image1